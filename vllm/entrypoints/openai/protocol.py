...
class ChatCompletionRequest(OpenAIBaseModel):
    ...
    cache_salt: Optional[Union[str, dict]] = Field(
        default=None,
        description=
        ("If specified, the prefix cache will be salted with these values. "
         "This is used to prevent an attacker to guess the prompt of a "
         "request. If a single string is provided, the salt is applied to the "
         "first block. If a dict is provided, the key is the index of message "
         "and the value is the salt to be used for the first block of that "
         "message."))
