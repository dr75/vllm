...
class KVCacheManager:
    ...
    def __init__(
        ...
        self.caching_hash_function = sha256 if caching_hash_algo == "sha256" else hash
    ...
    def get_computed_blocks(
        ...
        if not block_hashes:
            block_hashes = hash_request_tokens(self.caching_hash_function, self.block_size, request)
    ...
    def allocate_slots(
        ...
        self.block_pool.cache_full_blocks(
            ...
            hash_function=self.caching_hash_function,
        )
